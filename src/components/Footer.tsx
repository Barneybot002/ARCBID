...
export default function Footer() {
    return (
        <footer className="relative px-4 pb-12 pt-8 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-6xl">
                {/* CTA */}
                <ScrollReveal>
                    <div className="py-16 text-center">
                        <h2 className="font-heading text-3xl font-bold text-white sm:text-5xl md:text-6xl">
                            Start bidding with{" "}
                ...
                <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
                    ...
                    <p className="text-xs text-zinc-600">
                        Trustless auctions on Solana. Powered by Arcium.
                    </p>

                    <Link
                        href="https://github.com/Barneybot002/ARCBID"
                        target="_blank"
